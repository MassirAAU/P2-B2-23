...
%\input{intro/indledning}
%\input{intro/projektanalyse}

%Kontekstuelt%


%\input{kontekst/initierendeproblem}

%\input{kontekst/Geologiskhistorieundersoegelse}

%\input{kontekst/Jordbundsundersoegelse}

%\input{kontekst/Byudvikling}

%\input{kontekst/Interessantanalyse}

%\input{kontekst/Delkonklusion}

%\input{kontekst/Problemanalyse}

\input{teknisk/Geotekniskundersoegelse}

\input{teknisk/Laster}

%\input{teknisk/Egenlast}
